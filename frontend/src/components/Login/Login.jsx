  ...
  return (
    <>
      <header className="px-12 py-8">
        <div className="logo">
          <Link to="/">
            <img src="/assets/Groovy-logos_white.png" width={200} alt="" />
          </Link>
        </div>
      </header>
      <div className="bg-[#1a1919] py-10 w-full">
        <div className="bg-black py-10 text-center w-1/2 mx-auto rounded-lg">
          <h1 className="text-5xl my-12 font-semibold">Log in to Groovy</h1>
          ...
          <form onSubmit={loginUser} className="text-center mx-auto w-1/2 ">
            ...
            <div className="w-full text-left py-4">
              <input
                ...
                value="Log in"
                placeholder="Password"
                className="block cursor-pointer w-full outline-none bg-red-600 text-black p-3 hover:scale-105 translate-all duration-200 font-medium hover:font-semibold text-center rounded-full "
              />
            </div>
          ...
          <p className="pt-8">
            ...
            <Link
              to="/signup"
              className="text-white hover:text-red-600 font-semibold underline mx-auto"
            >
              Sign up for Groovy
            </Link>
          </p>
