    ...
    <>
      <div className="py-8 bg-white">
        <div className="logo text-center">
          <Link to="/">
            <img
              src="/assets/Groovy-logos_black.png"
              className="mx-auto"
              width={200}
              alt=""
            />
        ...
        <div className=" text-black">
          <div className="py-10 text-center w-1/2 mx-auto">
            ...
            >
              ...
              <div className="w-full text-left py-4">
                <input
                  type="submit"
                  value="Sign up"
                  className="block cursor-pointer w-1/2 mx-auto outline-none bg-red-500 text-black p-3 hover:scale-105 translate-all duration-200 font-medium hover:font-semibold text-center rounded-full "
                />
              </div>
            </form>
            ...
            <p className="pt-8">
              ...
              <Link
                to="/login"
                className="text-red-500 hover:text-red-500/90 font-semibold underline mx-auto"
              >
                Log in
              </Link>
            </p>
